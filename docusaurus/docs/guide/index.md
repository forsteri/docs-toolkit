---
title: ツールキット概要
description: 文書の書き方・見せ方・作り方をまとめた個人用ツールキットの全体像と、形式の選び方です。
---

# ツールキット概要

このリポジトリ（docs-toolkit）は、技術文書とプレゼンテーションの**書き方・見せ方・作り方**をまとめた個人用のツールキットです。文書本文はMarkdownを原本とし、用途に応じて4つの出力形式と図解基盤を使い分けます。
...
現在は**v0.1.0**です。変更履歴はリポジトリルートの`CHANGELOG.md`、経緯はルートの`Issues/`を参照してください。
